...
export const variableDefinitions: Record<string, VariableDefinition> = {
    ...
    cube3d_extrusionDepth: {
        defaultValue: 0,
        type: 'number',
        label: 'Extrusion Depth',
        description: 'How far the square has been extruded into the third dimension (0 = flat, 1 = full cube)',
        min: 0,
        max: 1,
        step: 0.01,
        color: '#F7B23B',
    ...
    cube3d_sideLength: {
        ...
        type: 'number',
        label: 'Side Length',
        description: 'Side length of the base square',
        min: 1,
        max: 3,
        step: 0.5,
        color: '#F7B23B',
    },
    cube3d_crossSectionCount: {
        defaultValue: 0,
        type: 'number',
        label: 'Cross-Section Count',
        description: 'Derived: number of ghost cross-sections shown during extrusion',
        color: '#F7B23B',
    },
    cube3d_volume: {
        defaultValue: 0,
        type: 'number',
        label: 'Volume',
        description: 'Derived: volume of the cube = sideLength³ × extrusionDepth',
        color: '#F7B23B',
    },
    cube3d_faces: {
        defaultValue: 1,
        type: 'number',
        label: 'Faces',
        description: 'Derived: number of faces visible (1 at start, 6 when complete)',
        color: '#F7B23B',
    },
    cube3d_edges: {
        defaultValue: 4,
        type: 'number',
        label: 'Edges',
        description: 'Derived: number of edges visible (4 at start, 12 when complete)',
        color: '#F7B23B',
    },
    cube3d_vertices: {
        defaultValue: 4,
        type: 'number',
        label: 'Vertices',
        description: 'Derived: number of vertices visible (4 at start, 8 when complete)',
        color: '#F7B23B',
    },
    cube3d_hasInteracted: {
        defaultValue: false,
        type: 'boolean',
        label: 'Has Interacted',
        description: 'Whether the student has started dragging the handle',
    },
    answerCube3dDimension: {
        defaultValue: '',
        type: 'select',
        label: 'Cube Dimension Answer',
        description: 'Student answer for how many dimensions a cube has',
        placeholder: '?',
        correctAnswer: 'three',
        options: ['one', 'two', 'three', 'four'],
        color: '#F7B23B',
    },
    answerCube3dVerticesFromSquare: {
        defaultValue: '',
        type: 'select',
        label: 'Vertices Doubling Answer',
        description: 'Student answer for what happens to vertices when extruding',
        placeholder: '?',
